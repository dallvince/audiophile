...
<head>
    ...
    <link rel="stylesheet" href="CSS/Yx1EarphonesPage.css">
    ...
    <section id="pdt_container">
        ...
        <div id="pdt_details">
            <div id="pdt_text">
                ...
                <h4 id="pdt_title">yx1 wireless earphones</h4>
                <p id="pdt_description">Tailor your listening experience with bespoke dynamic drivers from the new YX1 Wireless Earphones. Enjoy incredible high-fidelity sound even in noisy environments with its active noise cancellation feature.</p>
                <p id="price">$ 599</p>
                    <div id="cart">
                        <div id="pdt_number">
    ...
    <section id="feature_box">
        ...
        <div id="inthebox">
            ...
            <div id="inthebox_items">
                <p><span class="orange_span">2X</span> Earphone Unit</p>
                <p><span class="orange_span">6X</span> Multi-size Earplugs</p>
                <p><span class="orange_span">1X</span> User Manuel</p>
                <p><span class="orange_span">1X</span> USB-C Charging Cable</p>
                <p><span class="orange_span">1X</span> Travel Pouch</p>
            </div>
        </div>
    </section>
    <!-- PICTURES -->
